...
#[inline(always)]
pub const fn sub(l: [u64; 4], r: [u64; 4]) -> [u64; 4] {
...
#[inline(always)]
pub const fn wrapping_add(l: [u64; 4], r: [u64; 4]) -> [u64; 4] {
    overflowing_add(l, r).0
}

#[inline(always)]
pub const fn wrapping_sub(l: [u64; 4], r: [u64; 4]) -> [u64; 4] {
    overflowing_sub(l, r).0
}

#[inline(always)]
pub const fn overflowing_add(l: [u64; 4], r: [u64; 4]) -> ([u64; 4], bool) {
...
#[inline(always)]
pub const fn overflowing_sub(l: [u64; 4], r: [u64; 4]) -> ([u64; 4], bool) {
