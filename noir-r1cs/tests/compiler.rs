// use {
//     noir_r1cs::NoirProofScheme, serde::Deserialize, std::path::Path,
//     test_case::test_case,
// };
...
//     let nargo_toml =
// std::fs::read_to_string(&nargo_toml_path).expect("Reading Nargo.toml");
//     let nargo_toml: NargoToml =
// toml::from_str(&nargo_toml).expect("Deserializing Nargo.toml");

//     let package_name = nargo_toml.package.name;

//     let circuit_path =
// test_case_path.join(format!("target/{package_name}.json"));
...
// #[test_case("../noir-examples/noir-r1cs-test-programs/
// simplest-read-only-memory")] #[test_case("../noir-examples/
// noir-r1cs-test-programs/read-only-memory")] #[test_case("../noir-examples/
// noir-r1cs-test-programs/range-check-u8")] #[test_case("../noir-examples/
// noir-r1cs-test-programs/range-check-u16")] #[test_case("../noir-examples/
// noir-r1cs-test-programs/range-check-mixed-bases")] #[test_case("../
// noir-examples/noir-r1cs-test-programs/read-write-memory")] #[test_case("../
// noir-examples/noir-r1cs-test-programs/conditional-write")] #[test_case("../
...
// "complete_age_check")] fn case(path: &str) {
//     test_compiler(path);
// }
